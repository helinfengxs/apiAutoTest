...
public class ReportListener implements IReporter {
	...
	private final String path =System.getProperty("user.dir") +  File.separator+"接口测试报告.html";
	...
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		...
		for (ISuite suite : suites) {
			...
			for (ISuiteResult suiteResult : suiteResults.values()) {
				...
				testsPass = CommonParam.rightCount;
				IResultMap failedTests = testContext.getFailedTests();
				testsFail = CommonParam.errorCount;
	...
	private void outputResult(List<ITestResult> list) {
		...
		try {
			...
			result.put("testName", CommonParam.testTile);
			...
			result.put("testResult",CommonParam.resultData);
